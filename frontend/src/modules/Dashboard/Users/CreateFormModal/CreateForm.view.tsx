import { useMemo, useReducer, type KeyboardEventHandler } from 'react';
...
const CreateFormView: React.FC<CreateFormViewProps> = ({
    ...
    const handleSearchPerson: KeyboardEventHandler<HTMLInputElement> = (event) => {
    ...
    ].filter(Boolean) as FieldAttributes<UserCreateFormValues>[], [isObligatory]);
    ...
    return (
        <>
            ...
            <label className={styles['obligatory-content']}>
                ...
                />
                <span className={styles['obligatory-label']}>
                    Campos obligatorios
                </span>
            </label>
