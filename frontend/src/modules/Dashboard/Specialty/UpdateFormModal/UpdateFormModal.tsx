...
import {
    FormProvider, type SubmitHandler, useForm
} from 'react-hook-form';
import { toast } from 'react-toastify';

import {
    type CommandAttributes, Form, type FieldAttributes
...
const UpdateFormModal: React.FC<Props> = ({ isOpen, onClose, specialty }) => {
    ...
    const handleUpdate: SubmitHandler<SpecialtyUpdateValues> = async (data) => {
